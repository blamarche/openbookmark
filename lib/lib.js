...
function bookmarknew(folderid) {
    bookmark_new = window.open("./bookmark_new.php?folderid=" + selected_folder_id, "bookmarknew","toolbar=no,location=no,status=no,scrollbars=yes,resizable=yes,width=500,height=500");
}
...
function foldernew(folderid) {
  folder_new = window.open("./folder_new.php?folderid=" + selected_folder_id, "foldernew", "toolbar=no,location=no,status=no,scrollbars=yes,resizable=yes,width=500,height=200");
}

function folderedit(folderid) {
  if (selected_folder_id=="" || selected_folder_id=='0'){
    alert("No Folder selected.");
  }
  else {
    folder_edit = window.open("./folder_edit.php?folderid=" + selected_folder_id, "folderedit", "toolbar=no,location=no,status=no,scrollbars=yes,resizable=yes,width=500,height=220");
  }
}
...
function foldermove(folderid) {
  if (selected_folder_id=="" || selected_folder_id=='0'){
    ...
    folder_move = window.open("./folder_move.php", selected_folder_id, "toolbar=no,location=no,status=no,scrollbars=yes,resizable=yes,width=500,height=450");
  }
}
...
function folderdelete(folderid) {
  if (selected_folder_id=="" || selected_folder_id=="0"){
    ...
    folder_delete= window.open("./folder_delete.php?folderid=" + selected_folder_id, "folderdelete", "toolbar=no,location=no,status=no,scrollbars=yes,resizable=yes,width=500,height=200");
  }
}
